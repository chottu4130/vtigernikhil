...
public class DataFlowBtProjectIntoOrginationTest
{
	...
	public static void main(String[] args) throws IOException, InterruptedException 
	{
		...
		driver.findElement(By.xpath("//img[@alt='Create Projects...']")).click();
		driver.findElement(By.name("projectname")).sendKeys(lastnum);
		...
		while(it1.hasNext())
		{
		    ...
		    String s1=driver.findElement(By.className("moduleName")).getText();
		    if(s1.contains("Organizations"))
		    {
		    	break;
		    }
		}
		...
		if(s.contains("Project Information"))
		{
